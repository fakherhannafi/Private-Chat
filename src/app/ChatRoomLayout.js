  ...
  render() {
    ...
    return (
      <Card className={classes.card}>
        <CardHeader
          avatar={<Avatar src={this.props.friendicon} />}
        ...
        <CardContent>
          <ChatRoomPaper
            ...
            friendicon={this.props.friendicon}
            messageList={this.props.messageList}
          />
        </CardContent>
        <CardActions>
          <InputBox
            sendMsgCallback={this.sendMsgCallback}
            pickFriendBoolean={this.props.pickFriendBoolean}
          />
        </CardActions>
      </Card>
    );
